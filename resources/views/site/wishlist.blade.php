@extends('layouts.site.app', [
    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-12">
            <h3 class="mt-3 mb-3 font-medium">{{__('msg.wishlist')}}</h3>
            </div>
            @if(auth()->check())
           ...
           @endif
            <!-- <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="cart-item mr-2 shadow-2 p-2  mb-4">
                    ...
                    <div class="cart-item-content">
                        <div class="d-flex flex-column justify-content-between">
                            <div class="cart-item-price d-flex my-2">
                                <span class="text-black font-black mr-3">$384.4</span>
                                <img src="{{asset('assets/site/img/icons/cart_2.png')}}" alt="">
                            </div> 
                            <div class="cart-item-details d-flex justify-content-between mt-4">
                                <div class="cart-item-desc-review align-self-end d-flex flex-column">
                                    <span class="text-black cart-item-tagline">Solo 3</span>
                                    <span class="text-grey cart-item-description">Wireless</span>
                                    <div class="ratings">
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                ...
                                <div class="cart-item-img ">
                                    <img src="{{asset('assets/site/img/main-product-image.png')}}" alt="">
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="cart-item mr-2 shadow-2 p-2  mb-4">
                    <div class="card-item-header d-flex justify-content-between">
                        ...
                        <div class="cart-items-options d-flex">
                            <button class="btn btn-transparent">
                                <img src="assets/img/icons/schedule.png" alt="">
                            </button>
                            <button class="btn btn-transparent">
                                <img src="{{asset('assets/site/img/icons/favorite_active.png')}}" alt="">
                            </button>
                    ...
                    <div class="cart-item-content">
                        <div class="d-flex flex-column justify-content-between ">
                            ...
                            <div class="cart-item-details d-flex justify-content-between mt-4" >
                                <div class="cart-item-desc-review align-self-end d-flex flex-column">
                                    <span class="text-black cart-item-tagline">Solo 3</span>
                                    <span class="text-grey cart-item-description">Wireless signature headset</span>
                                    <div class="ratings">
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="cart-item mr-2 shadow-2 p-2  mb-3">
                    <div class="card-item-header d-flex justify-content-between">
                        <span class="cart-item-category px-2">
                            PRODUCT
                        </span>
                    ...
                    <div class="cart-item-content">
                        <div class="d-flex flex-column justify-content-between">
                            ...
                            <div class="cart-item-details d-flex justify-content-between mt-4">
                                ...
                                <div class="cart-item-img">
                                    <img src="{{asset('assets/site/img/earphone.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cart-item-content">
                        <div class="d-flex flex-column justify-content-between">
                            ...
                            <div class="cart-item-details d-flex justify-content-between">
                                <div class="cart-item-desc-review align-self-end d-flex flex-column mt-4">
                                    <span class="text-black cart-item-tagline">Solo 3</span>
                                    <span class="text-grey cart-item-description">Wireless signature headset</span>
                                    <div class="ratings">
                                        <span class="fa fa-star checked"></span>
