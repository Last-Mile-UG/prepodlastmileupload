...
return [
    ...
    */
    ...
    'cipher' => 'AES-256-CBC',
    'date_format' => env('DATE_FORMAT', 'h:i A,d M y'),
    ...
    'premium_customer_package_price' => env('PREMIUM_CUSTOMER_PACKAGE_PRICE',8,99),

    'shop_radius' => env('SHOP_RADIUS', 5000),
    'mail_to_address' => env('MAIL_TO_ADDRESS', 'contact@thelastmile.shop'),
